...
// <-- handles search, category filter, hamburger menu, etc.
  // =======================
  // GLOBAL STATE
  // =======================
...
// With a dynamic getter inside filterProducts:
  function filterProducts() {
    const products = document.querySelectorAll(".product-card"); // get updated list every time
